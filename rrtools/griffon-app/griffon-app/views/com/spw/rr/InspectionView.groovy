                                        ...
                                        .and(couplerHeightPassA.selectedProperty()
                                                .and(metalWheelsB.selectedProperty()
                                                        .and(metalWheelsA.selectedProperty()
                                                                .and(metalWheelsB.selectedProperty()
                                                                        .and(resistanceWheelsB.selectedProperty()
                                                                                .and(resistanceWheelsA.selectedProperty()
                                                                                        .and(wheelGaugeB.selectedProperty()
                                                                                                .and(wheelGaugeA.selectedProperty()
                                                                                                        .and(wheelTreadB.selectedProperty()
                                                                                                                .and(wheelTreadA.selectedProperty()
                                                                                                                        .and(truckScrewTightB.selectedProperty()
                                                                                                                                .and(truckScrewLooseA.selectedProperty()
                                                                                                                                        .and(carSitsLevel.selectedProperty()
                                                                                                                                                .and(carDoesNotRock.selectedProperty()
                                                                                                                                                        .and(carDoesNotRock.selectedProperty()
                                                                                                                                                                .and(allWheelsTouch.selectedProperty()))))))))))))))))))))
    }
